...
def main():
    ...
    parser.add_argument("--k", type=int, default=50, help="Number of entries to process (if None, process all)")
    ...
    parser.add_argument("--args_path", type=str, default="", help="Arguments path")
